...
global.config = {
    ...
    mainnetExplorerUrlHash: "http://explorer.diamoneum.com/transaction.html?hash={ID}",
    mainnetExplorerUrlBlock: "http://explorer.diamoneum.com/block.html?height={ID}",
    testnetExplorerUrl: "http://testnet.diamoneum.com/",
    testnetExplorerUrlHash: "http://testnet.diamoneum.com/tx/{ID}",
    testnetExplorerUrlBlock: "http://testnet.diamoneum.com/block/{ID}",
    testnet: false,
    coinUnitPlaces: 8,
    txMinConfirms: 10,
